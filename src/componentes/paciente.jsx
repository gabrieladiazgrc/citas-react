function Paciente({ paciente, setPaciente }) {
    ...
    return (
        <div className="bg-slate-50 shadow-md mx-5 rounded-md">
            ...
            <div>
                <button type="submit" className="hover:bg-indigo-700 bg-indigo-600 uppercase rounded-md text-white px-10 font-bold" onClick={() => setPaciente(paciente)}>Editar</button>
                <button type="submit" className="hover:bg-red-700 bg-red-600 uppercase rounded-md text-white px-10 font-bold" onClick={eliminar}>Eliminar</button>
            </div>
        </div>
    )
}
